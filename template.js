...
const hintsCss =
  "font-size: 12pt; font-family: 'JetBrains Mono NL', 'Cascadia Code', 'Helvetica Neue', Helvetica, Arial, sans-serif; border: 0px; color: $text; background: $base; background-color: $base";
